    ...
    return (
        <div className="min-w-full sm:min bg-[#212F31] min-h-screen flex flex-row justify-center items-center">
            <div className="text-white w-11/12 sm:w-10/12 md:w-8/12 lg:w-6/12 h-min p-4 relative">
                ...
                <div className="p-8">
                    <p className=" font-quote text-2xl lg:text-3xl font-bold">The best thing about the future is that it only comes one day at a time.</p>
                    <snap className="block mt-6 font-author font-light text-xs uppercase"> <span className="text-green-400 text-xs">-</span> Abraham Lincoln</snap>
                </div>
